...
public class Bdd {
    ...
    private static final String URL_MONGO = "mongodb://localhost    ou  mongodb+srv://system:???????@cluster0.???????.mongodb.net";
    private static final String URL_NEO4J = "bolt://localhost:7687  ou  neo4j+s://????????.databases.neo4j.io";
